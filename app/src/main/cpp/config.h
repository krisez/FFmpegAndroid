...
#define FFMPEG_CONFIGURATION "--ln_s='cp -rf' --prefix=./Android/armv7a --cc='D:/technology/android-ndk-r20/toolchains/llvm/prebuilt/windows-x86_64/bin/armv7a-linux-androideabi16-clang' --cxx='D:/technology/android-ndk-r20/toolchains/llvm/prebuilt/windows-x86_64/bin/armv7a-linux-androideabi16-clang++' --ld='D:/technology/android-ndk-r20/toolchains/llvm/prebuilt/windows-x86_64/bin/armv7a-linux-androideabi16-clang' --target-os=android --arch=arm --cpu=armv7a --cross-prefix='D:/technology/android-ndk-r20/toolchains/llvm/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --enable-cross-compile --enable-shared --disable-static --enable-runtime-cpudetect --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-symver --enable-small --enable-gpl --enable-nonfree --enable-version3 --disable-iconv --enable-neon --enable-hwaccels --enable-jni --enable-mediacodec --enable-avdevice --disable-decoders --enable-decoder=vp9 --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=aac --enable-decoder=h264_mediacodec --enable-postproc --extra-cflags='-D__ANDROID_API__=16 -U_FILE_OFFSET_BITS -DBIONIC_IOCTL_NO_SIGNEDNESS_OVERLOAD -Os -fPIC -DANDROID -D__thumb__ -mthumb -Wfatal-errors -Wno-deprecated -mfloat-abi=softfp -marm' --extra-ldflags=-marm"
